...
import { FaUserTie, FaUserGraduate, FaUserCog, FaUserSecret, FaUserMd } from 'react-icons/fa'; // Importing some icons
    ...
    <div className="p-6 bg-gray-100 min-h-screen">
      ...
      <div className="space-y-6">
        {candidates.map((candidate) => (
          <div key={candidate.id} className="bg-white p-4 rounded-lg shadow-lg hover:shadow-xl transition">
            <div className="flex items-center space-x-4">
              <div className="bg-gray-200 rounded-full h-12 w-12 flex-shrink-0 flex items-center justify-center text-xl">
                {candidate.icon}
              </div> {/* Icon based on candidate */}
              <div>
            ...
            <div className="mt-4">
              ...
              <div className="mt-4">
                <p className="text-gray-600">Match Score: {candidate.matchScore}%</p>
